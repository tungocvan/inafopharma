        ...
        function custom_override_checkout_fields($fields)
        {
            ...
            if (!$this->get_options('enable_firstname')) {
                ...
                $fields['billing']['billing_last_name'] = array(
                    'label' => __('Họ và Tên', 'woo-vietnam-checkout'),
            ...
            $fields['billing']['billing_state'] = array(
                'label' => __('Tỉnh/Thành phố', 'woo-vietnam-checkout'),
                'required' => true,
                'type' => 'select',
            ...
            $fields['billing']['billing_city'] = array(
                'label' => __('Quận/Huyện', 'woo-vietnam-checkout'),
                'required' => true,
                'type' => 'select',
            ...
            if (!$this->get_options()) {
                $fields['billing']['billing_address_2'] = array(
                    'label' => __('Xã/Phường/Thị trấn', 'woo-vietnam-checkout'),
                    'required' => true,
                    'type' => 'select',
